...
package axl.xdef.types
{
	 ...
	 * masked contents within masked area</li><li>exposes ability to make bi-directional connection with <code>xScroll</code>
	 * (&lt;scrollBar/&gt;) instance </li></ul>*/
	public class xMasked extends xSprite
	{
		...
		/** Deterimines if masked content movement can be triggered by mouse wheel events. 
		 * @see #deltaMultiplier */
